...
class Media {
    ...
    onResize({ screen, viewport } = {}) {
        ...
        this.plane.scale.y = (this.viewport.height * (900 * this.scale * this.planeScale)) / this.screen.height;
        this.plane.scale.x = (this.viewport.width * (700 * this.scale * this.planeScale)) / this.screen.width;
